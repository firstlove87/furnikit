...
;(function($, undefined) {
	'use strict';
	// furnikit image data-uri bypasses webkit log warning (thx doug jones)
	var FURNIKIT = 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==';
	...
	$.fn.imagesLoaded = function( callback ) {
		...
		function imgLoaded( img, isBroken ) {
			// don't proceed if FURNIKIT image, or image is already loaded
			if ( img.src === FURNIKIT || $.inArray( img, loaded ) !== -1 ) {
				return;
			}
