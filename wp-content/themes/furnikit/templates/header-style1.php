		...
		<div class="container">
			<div class="row">
				...
				<?php if( !zr_options( 'disable_search' ) ) : ?>
					<div class="search-cate col-lg-1 col-md-2 pull-left">
				...
				<div id="main-menu" class="main-menu col-lg-10 col-md-8 pull-left clearfix">
				...
				<?php if( !zr_options( 'disable_cart' ) ) : ?>
					<div class="header-cart col-lg-1 col-md-2 pull-left">
