...
function zr_import_files() { 
	return array(
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'furnikit' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_furnikit/home-page-2/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'furnikit' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_furnikit/home-page-4/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'furnikit' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_furnikit/home-page-3/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'furnikit' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_furnikit/home-page-6/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'furnikit' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_furnikit/home-page-5/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'furnikit' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_furnikit/home-page-7/' ),
    ),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'furnikit' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_furnikit/home-page-8/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'furnikit' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_furnikit/furniture-store-2/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'furnikit' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_furnikit/home-page-9/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'furnikit' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_furnikit/home-page-10/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'furnikit' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_furnikit/home-page-11/' ),
		),
	);
}
