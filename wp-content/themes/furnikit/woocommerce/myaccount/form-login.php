	...
	<div class="col-lg-6 col-md-6 col-sm-12">
		...
		<form method="post" class="login">
			...
			<p class="form-row form-row-wide">
				<label for="username"><?php esc_html_e( 'Username or email address', 'furnikit' ); ?><span class="required">*</span></label>
				<input type="text" class="input-text" name="username" id="username" value="" />
			</p>
			<p class="form-row form-row-wide">
				<label for="password"><?php esc_html_e( 'Password', 'furnikit' ); ?><span class="required">*</span></label>
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="col-lg-6 col-md-6 col-sm-12">
		...
		<h2><?php esc_html_e( 'Register', 'furnikit' ); ?></h2>
		...
		<form method="post" class="register">
			...
			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) : ?>
				...
				<p class="form-row form-row-wide">
					<label for="reg_username"><?php esc_html_e( 'Username', 'furnikit' ); ?> <span class="required">*</span></label>
			...
			<p class="form-row form-row-wide">
				<label for="reg_email"><?php esc_html_e( 'Email address', 'furnikit' ); ?> <span class="required">*</span></label>
