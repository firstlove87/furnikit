...
<div class="container">
	...
	<!-- Left Sidebar -->
	<?php 	
	if ( is_active_sidebar('left-product') && furnikit_sidebar_product() != 'right' && furnikit_sidebar_product() != 'full' ):
	...
	<div id="contents" <?php furnikit_content_product(); ?> role="main">
		<?php
			/**
		...
		<div class="products-wrapper">	
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php 					
					...
					if( zr_woocommerce_version_check( '3.3' ) ){
						echo apply_filters( 'furnikit_custom_category', $html = '' );
					}else{
	...
	<!-- Right Sidebar -->
	<?php if ( is_active_sidebar('right-product') && furnikit_sidebar_product() != 'left' && furnikit_sidebar_product() != 'full' ):
