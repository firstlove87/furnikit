		...
		<div class="child-top">
			...
			?>			
				...
				<?php 
					...
					echo '<li><a href="' . $viewall . '"><i class="fa  fa-caret-right"></i>' .esc_html__('View all', 'zr_core') . '</a></li>';
					echo '</ul>';
				?>
				</div>
				<?php } ?>
