<?php 
	$widget_id = isset( $widget_id ) ? $widget_id : 'zr_brand_'.$this->generateID();
	$term_brands = array();
...
?>
	<div id="<?php echo esc_attr( $widget_id ) ?>" class="responsive-slider zr-brand-container-slider <?php echo esc_attr( $style ); ?> loading clearfix" data-lg="<?php echo esc_attr( $columns ); ?>" data-md="<?php echo esc_attr( $columns1 ); ?>" data-sm="<?php echo esc_attr( $columns2 ); ?>" data-xs="<?php echo esc_attr( $columns3 ); ?>" data-mobile="<?php echo esc_attr( $columns4 ); ?>" data-speed="<?php echo esc_attr( $speed ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>" data-autoplay="<?php echo esc_attr( $autoplay ); ?>">
		<?php if( $title1 != '') { ?>
			<?php if( $style == '') {?>
