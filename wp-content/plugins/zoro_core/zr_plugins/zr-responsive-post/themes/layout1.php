						...
						<div class="item-detail">
							<div class="img_over">
								...
								if ( has_post_thumbnail( $post->ID ) ){
										echo get_the_post_thumbnail( $post->ID, 'mocha_blog-responsive2' ) ? get_the_post_thumbnail( $post->ID, 'mocha_blog-responsive2' ): '<img src="'.get_template_directory_uri().'/assets/img/placeholder/'.'large'.'.png" alt="No thumb">';		
								}else{
							...
							<div class="entry-content">
								...
								<div class="readmore"><i class="fa fa-caret-right"></i><a href="<?php echo get_permalink($post->ID);?>" title="View more" ><?php esc_html_e('Read more','zr_core');?></a></div>
							</div>
						</div>
					</div>
				</div>
