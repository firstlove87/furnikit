...
(function ($) {
	...
	window.InlineShortcodeView_woo_tab_cat_slider = window.InlineShortcodeView.extend( {
		render: function () {
			...
			var $el 	= this.$el.find( '.zr-woo-tab-cat' );
			var $id 	= this.$el.find( '.responsive-slider' );	
			var $target = this.$el.find( '.responsive' );
			var $append = $id;
			vc.frame_window.vc_iframe.addActivity( function () {
	...
	window.InlineShortcodeView_zr_brand = window.InlineShortcodeView.extend( {
		render: function () {
			window.InlineShortcodeView_zr_brand.__super__.render.call( this );
			var $id 	= this.$el.find( '.responsive-slider' );
			var $target = this.$el.find( '.responsive' );
			var $append = $id;
			vc.frame_window.vc_iframe.addActivity( function () {
