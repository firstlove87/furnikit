...
(function($, doc, win){
    ...
    */
        ...
        changeActive : function(index, delay, thumbClick){
            ...
            this.changeActiveTimeout = setTimeout( 
                function(){
                    ...
                    thumbs.animate({scrollLeft: pos}, 500, 'zring');
                }, 200);
        },
    ...
    /**
     * jQuery Plugin to add basic "zripe" support on touch-enabled devices
     * 
     * @author Yair Even Or
    ...
    $.event.special.zripe = {
        setup: function(){
            $(this).bind('touchstart', $.event.special.zripe.handler);
        },

        teardown: function(){
            $(this).unbind('touchstart', $.event.special.zripe.handler);
        },
