<?php
class ZR_Options_button_set extends ZR_Options{	
	...
	*/
	function enqueue(){
		...
		wp_enqueue_style('zr-opts-jquery-ui-css');

		wp_enqueue_script(
			'zr-opts-field-button_set-js', 
			ZR_Options_URL.'fields/button_set/field_button_set.js', 
