...
(function($) { 
        ...
        var append = $(this).find('.search-append');
         ...
         var serviceUrl = zr_livesearch.ajaxurl + '?action=zr_search_products_callback&limit=' + limit + '&search_type=' + searchtype;
         ...
         $(this).find('.autosearch-input').devbridgeAutocomplete({
					...
					formatResult: function (suggestion, currentValue) {
						...
						if( suggestion.id != -1 ){
							...
							if( suggestion.sku != '' ){
								html += '<div class="sku"><span>' + zr_livesearch.sku + ': </span>'+suggestion.sku.replace(new RegExp(pattern, 'gi'), '<strong>$1<\/strong>')+'</div>';
							}
							if( showprice ){
							...
							search_categories.on( 'change', function( e ){
									...
									if( search_categories.val() != '' ) {
											searchForm.setOptions({
													serviceUrl:  zr_livesearch.ajaxurl + '?action=zr_search_products_callback&limit=' + limit + '&search_type=' + searchtype + '&product_cat=' + search_categories.val()
											});
									} else{
											searchForm.setOptions({
													serviceUrl:  zr_livesearch.ajaxurl + '?action=zr_search_products_callback&limit=' + limit + '&search_type=' + searchtype
											});
									}
									searchForm.hide();
