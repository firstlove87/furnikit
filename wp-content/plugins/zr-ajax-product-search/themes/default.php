		...
		<div id="<?php echo esc_attr( $id_widget ); ?>" class="search-wrapper" 
			...
			<div class="cat-wrapper">
				<select name="category" class="s1_option category-selection">
					<option value=""><?php echo esc_html__( 'All Category','zr-ajax-product-search' ) ; ?></option>
			...
			<div class="content-search">
				<input class="autosearch-input" type="text" value="<?php echo ( ( isset( $_GET['s'] ) && $_GET['s'] ) ? ( $_GET['s'] ) : "" ); ?>" size="50" autocomplete="off" placeholder="<?php echo esc_attr__( 'Search Item...', 'zr-ajax-product-search' ); ?>" name="s">	
